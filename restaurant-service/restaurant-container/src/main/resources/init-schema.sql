...
CREATE MATERIALIZED VIEW restaurant.order_restaurant_m_view TABLESPACE pg_default
AS
...
CREATE trigger refresh_order_restaurant_m_view after INSERT OR UPDATE OR DELETE OR truncate
