...
DROP TYPE IF EXISTS "payment".order_status;
...
CREATE INDEX "payment_order_outbox_saga_status" ON "payment".order_outbox
  (type, payment_status);

CREATE UNIQUE INDEX "payment_outbox_saga_id_payment_status_outbox_status"
